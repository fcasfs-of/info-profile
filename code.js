...
let menu_lifnks = document.querySelector(".footer__nav > .footer__nav-links > .zlink");
let menu_links = document.querySelector("#home > .navbar")[0].querySelector(".navbar__ul > .link");
